      ...
      return (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/70">
          <motion.div
            ...
            className="bg-gray-900 border border-gray-800 rounded-2xl p-8 max-w-lg mx-4"
          >
          ...
          >
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:border-brand-500 focus:outline-none"
              />
            </div>
                ...
                {['A2', 'B1', 'B2', 'C1'].map(l => (
                  <button
                    ...
                    className={`py-2.5 rounded-lg text-sm font-medium transition-colors ${
                      level === l ? 'bg-brand-600 text-white' : 'bg-gray-800 text-gray-400 hover:bg-gray-700'
                    }`}
                  >
                    {l}
                  </button>
          ...
          >
              ...
              <div className="grid grid-cols-3 gap-2">
                {(['claude', 'gemini', 'ollama'] as const).map(p => (
                  <button
                    ...
                    className={`py-2.5 rounded-lg text-sm font-medium transition-colors ${
                      activeProvider === p ? 'bg-brand-600 text-white' : 'bg-gray-800 text-gray-400 hover:bg-gray-700'
                    }`}
                  >
              ...
              <div className="mb-4 space-y-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={ollamaUrl}
                    onChange={e => useSettingsStore.getState().setOllamaUrl(e.target.value)}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={ollamaModel}
                    onChange={e => useSettingsStore.getState().setOllamaModel(e.target.value)}
            ...
            {(activeProvider === 'claude' && !claudeApiKey) ||
             (activeProvider === 'gemini' && !geminiApiKey) ? (
              <div className="mb-6 p-3 bg-amber-950/30 border border-amber-800/50 rounded-lg">
